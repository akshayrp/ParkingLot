...
public class parkingLotSystemTest {
    ...
    public void givenMultipleCarDetails_ShouldParkCarOnAnEmptySlot() {
        try {
            ...
            Integer emptySlot1 = parkingLotSystem.availabilityChecker.giveEmptySlot();
            ...
            Integer emptySlot2 = parkingLotSystem.availabilityChecker.giveEmptySlot();
            ...
            Integer emptySlot3 = parkingLotSystem.availabilityChecker.giveEmptySlot();
    ...
    public void givenCarSlotNumber_WhenCarAvailable_UnParkCarShouldReturnTrue() {
        try {
            int emptySlotForFirstCar = parkingLotSystem.availabilityChecker.giveEmptySlot();
    ...
    public void givenMultipleCarDetails_WhenParkingLotFull_ShouldInformParkingFull() {
        try {
            ...
            Integer emptySlot4 = parkingLotSystem.availabilityChecker.giveEmptySlot();
            ...
            Integer emptySlot5 = parkingLotSystem.availabilityChecker.giveEmptySlot();
